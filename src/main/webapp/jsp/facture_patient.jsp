                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><% out.print(p[i].getNom()); %></td>
                                        <td><% out.print(p[i].getSexe()); %></td>
                                        <td><% out.print(p[i].getDate_n()); %></td>
                                        <td><% out.print(p[i].getMail()); %></td>
                                        <td><% out.print(p[i].getAdresse()); %></td>
                                        <%
                                            ...
                                            for(me=0;me<m.length;me++){
                                                ...
                                                {
                                        %>
                                        <td><% out.print(m[me].getNomemploie()); %></td>
                                        <%
                                            }
                                            }
                                        %>
                                        <td><a href="ok.jsp?id=<%  out.print(p[i].getId_patient()); %>"><input type="button" class="btn btn-danger" value="Payer la consultation"></a></td>
                                    </tr>
                                </tbody>
                                <% } %>
                            </table>
