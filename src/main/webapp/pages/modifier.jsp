...
<body>
	...
	<section class="main clearfix" style="background:white;">
            <div class="container">
            <h2>Modification de l'employé</h2>
            <br/>
                <%
                        ...
                        //out.print(m.length);
                    %>
                    <form role="form" method="get" action="../jsp/modification.jsp">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="name" value="<% out.print(m[a].getNomemploie()); %>" name="name" style="border:solid 1px black;">
                        </div>
                      </div>
                      <br/>
                      <br/>
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select name="sexe" class="form-control" style="border:solid 1px black;height:50px;">
                                <option value="<% out.print(m[a].getSexee()); %>"><% out.print(m[a].getSexee()); %></option>
                                <%
                                    Fonction fe=new Fonction();
                                    String sexe_contraire = fe.sexe_contraire(m[a].getSexee());
                                %>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="date" class="form-control" name="date_nais" value="<% out.print(m[a].getDate_naisse()); %>" id="date_nais" style="border:solid 1px black;height:50px;">
                        </div>
                      </div>
                      <br/>
                      <br/>
                        ...
                        <div class="col-sm-10">
                            <select name="mart" class="form-control" style="border:solid 1px black;height:50px;">
                                <%
                                    ...
                                    for(int s=0;s<situation.length;s++)
                                    {
                                      situation[0]="Celibataire";
                                      situation[1]="Mariée";
                                      situation[2]="En couple";
                                      situation[3]="Fiancée";
                                      situation[4]="Veuve(fe)";
                                      if(m[a].getMariagee().equals(situation[s]))
                                      {
                                %>
                                <option value="<% out.print(m[a].getMariagee()); %>"><% out.print(m[a].getMariagee()); %></option>
                                <%
                                    break;
                                    }
                                    }
                                ...
                                %>
                                <option value="<% out.print(situation[s]); %>"><% out.print(situation[s]); %></option>
                                <%
                                    }
                                %>
                            </select>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="adresse" value="<% out.print(m[a].getAdressee()); %>" id="adresse" style="border:solid 1px black;">
                        </div>
                      </div>
                      <br/>
                      <br/>
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="email" value="<% out.print(m[a].getEmail()); %>" id="email" style="border:solid 1px black;">
                        </div>
                      </div>
                      <br/>
                      <br/>
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="phone" value="<% out.print(m[a].getContact()); %>" id="phone" style="border:solid 1px black;">
                        </div>
                      </div>
                      <br/>
                      <br/>
                            ...
                            <div class="col-sm-10">
                                ...
                                <% 
                                    ...
                                    for(i=0;i<p.length;i++){
                                        ...
                                        {
                                %> 
                                    <option value="<% out.print(m[a].getId_occupations()); %>"><% out.print(p[i].getOccupation()); %></option>  
                                <% break;}}
                                        for(i=0;i<p.length;i++){
                                        if(p[i].getId_occupations()==m[a].getId_occupations())
                                        {
