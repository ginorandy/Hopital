...
<body>
	...
	<header style="border:solid 1px black ;">
		...
		<nav>
			<ul>
				...
				<li><a href="recherche.jsp"  class="selected">Rechercher des employés</a></li>
			</ul>
	...
	<section class="main clearfix" style="background:white;">
            ...
            <br/>
                <form role="form" method="get" action="../jsp/rechercher.jsp">
                    <br/>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="sexe" placeholder="Sexe" id="sexe" style="border:solid 1px black;">
                    </div>
                  </div>
                  <br/>
                  <br/>
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="date_nais" placeholder="Date de naissance" id="date_nais" style="border:solid 1px black;">
                    </div>
                  </div>
                  <br/>
                  <br/>
                  <div class="form-group">
                    <label class="control-label col-sm-2" for="sexe">Situation martiale:</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="mart" placeholder="Situation martiale" id="mart" style="border:solid 1px black;">
                    </div>
                  </div>
                  <br/>
                  <br/>
