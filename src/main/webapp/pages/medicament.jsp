...
<body>
	...
	<header style="border:solid 1px black ;">
		...
		<nav>
			<ul>
				...
				<li><a href="recherche_m.jsp" class="selected">Recherche</a></li>
	...
	<section class="main clearfix" style="background:white;">
            ...
            <br/>
                <form role="form" method="get" action="consulter.jsp">
                    <br/>
                  ...
                  <div class="form-group">
                    <div class="col-sm-10">
                        <input type="hidden" class="form-control" id="id" name="id" value="<% out.print(id); %>" style="border:solid 1px black;">
                    </div>
                  </div>
                  <br/>
                  <br/>
                  <div class="form-group">
                    <label class="control-label col-sm-2" for="nom">Désignation:</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="name" name="name" style="border:solid 1px black;">
                    </div>
                  </div>
                  <br/>
                  <br/>
