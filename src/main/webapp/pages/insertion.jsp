...
<body>
	...
	<header style="border:solid 1px black ;">
		...
		<nav>
			<ul>
				<li><a href="insertion.jsp" class="selected">Insertion</a></li>
				<li><a href="recherche_m.jsp">Recherche</a></li>
            ...
            <br/>
                <form role="form" method="get" action="../jsp/insert_medic.jsp">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="date" class="form-control" id="date_me" name="date_me" style="border:solid 1px black;">
                    </div>
                  </div>
